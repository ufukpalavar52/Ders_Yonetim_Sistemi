...
<html>
    ...
    <title>Yönetim Paneli || Ders Ataması Yap</title>
...
xmlhttp.open("GET","dersBilgiAl.jsp?id="+str,true);
xmlhttp.send();
}
</script>   
</head>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" action="./dersAta" method="post">
              <%
             ...
             %>
                ...
                <div class="form-group">
                    <label for="name" class="col-sm-2 control-label">Akademisyen Bölümü</label>
                   
                    <div class="col-sm-5">
                        <select class="form-control" name="bolum" onchange="bilgiGoster(this.value)">
                            <option value="">Akademisyenin Bölümünü seç</option>   
                         <% while(rs.next()){ %>
